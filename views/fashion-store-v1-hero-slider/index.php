...
/* @var $searchModel frontend\themes\createx\modules\fashion_store_v1_hero_slider\models\FashionStoreV1HeroSliderSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Fashion Store V1 Hero Sliders');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="fashion-store-v1-hero-slider-index">

    <p>
        <?= Html::a(Yii::t('app', 'Create Fashion Store V1 Hero Slider'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
